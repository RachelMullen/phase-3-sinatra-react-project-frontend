  ...
  return (
    <React.Fragment>
      ...
      <>
        ...
        <p><LocationOnIcon sx={{ verticalAlign: "middle", marginRight:'5px'}} /> - {user[0].locale}</p>
        <p>{user[0].bio}</p>
      ...
      <br />
      { series === 0 ? <button onClick={() => setSeries(1)}>Advanced Options</button> : null}
      { series === 1 ? <button onClick={() => setSeries(2)}>Please Only Use If You're A Developer</button> : null}
      { series === 2 ? <button onClick={() => setSeries(3)}>Seriously, Please Only Use If You're A Developer</button> : null}
      { series === 3 ? <button onClick={() => setSeries(4)}>Rachel has approved this idea</button> : null}
      { series === 4 ? <button onClick={() => setSeries(5)}>Luke has approved this idea</button> : null}
      { series === 5 ? <button onClick={() => setSeries(6)}>Cassidy has approved this idea</button> : null}
